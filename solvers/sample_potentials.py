...
class FiniteQuantumWell(GenericPotential):
    """
    This class provides a device that simulates a simple quantum well, 
    ...
    def __init__(self, wh, wl):
        ...
        self.surround_times = 1 # on each side
        ...
        self.pts = lambda l: int(l * float(self.N) / \
            self.system_length_nm)
